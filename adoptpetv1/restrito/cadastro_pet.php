    ...
    html, body {
     ...
     .navbar-custom {
      ...
      .navbar-toggler-icon {
        ...
        display: flex;
        flex-direction: column;
        gap: 40px; /* Espaço de 15 pixels entre os botões */
      }
        .box-gray {
        background-color: rgba(235, 235, 235, 0.7);
        padding: 20px;
      ...
      /* Estilo para a caixa cinza ao redor do formulário */
      .form-box {
        background-color: rgba(235, 235, 235, 0.7);
        padding: 20px;
        border-radius: 8px;
    ...
    <div class="container mt-5 content">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <h1 class="text-center">Cadastro Pet</h1>
                <form action="processacadastro_pet.php" method="POST">
                    <div class="form-group">
                        <label for="CODpet">Código do Pet:</label>
                        <input type="text" class="form-control" name="CODpet" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center">
                        <input type="submit" class="btn btn-success btn-custom btn-container" value="Cadastrar">
                    </div>
                    <div class="text-center">
                        <a href="../index.php" class="btn btn-primary mt-3 btn-custom btn-container">Voltar para o início</a>
                </div>
            </div>
        </div> 
    </div>
