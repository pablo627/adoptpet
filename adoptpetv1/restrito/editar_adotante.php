...
$sql = "SELECT * FROM adotante WHERE CPF = '$id'";

// Consultas preparadas são recomendadas para evitar injeção SQL
$stmt = $conn->prepare("SELECT * FROM adotante WHERE CPF = ?");
    ...
    <div class="container mt-5 content">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <h1 class="text-center">Edição Adotante</h1>
                <form action="processaedicao_adotante.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sexo">
                            <option value="masculino" <?php echo ($linha['sexo'] == 'masculino') ? 'selected' : ''; ?>>Masculino</option>
                            <option value="feminino" <?php echo ($linha['sexo'] == 'feminino') ? 'selected' : ''; ?>>Feminino</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="endereco">Endereço:</label>
                        <input type="text" class="form-control" name="endereco" required value="<?php echo htmlspecialchars($linha['endereco']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="quantpets">Quantidade de Pets:</label>
                        <input type="text" class="form-control" name="quantpets" required value="<?php echo htmlspecialchars($linha['quantpets']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="datanasc">Data de Nascimento:</label>
                        <input type="date" class="form-control" name="datanasc" required value="<?php echo htmlspecialchars($linha['datanasc']); ?>">
                    </div>
                ...
                <div class="text-center mt-2">
                    <a href="pesquisa_adotante.php" class="btn btn-primary btn-block">Cancelar</a>  
                </div>
            </div> 
        </div>
    </div>
